        ...
        <div class="signupSection">
            ...
            <form @submit.prevent="store" class="signupForm" name="signupform">
                ...
                <ul class="noBullet">
                    ...
                    <li
                        style="display: flex; flex-direction: row; justify-items: center;align-items: center;justify-content: center; gap:0.4rem;">
                        <label for="">Fiksna cena? </label>
                        <label for="da">Da</label>
                        <input v-model="form.fixed" type="radio" id="da" value="1" name="fixed" checked>
                            ...
                            <div class="Neon-input-dragDrop">
                                <div class="Neon-input-inner">
                                    ...
                                    <div class="Neon-input-text">
                                        <h3>*Prva slika je naslovna</h3> <span
                                            style="display:inline-block; margin: 20px 0"></span>
                                    </div>
                                    <a class="Neon-input-choose-btn blue">Odaberi slike</a>
                                </div>
                            </div>
                        </div>
                    </li>
